...
public class addActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String PASSWORD = "com.example.password_manager.PASSWORD";
    public static final String EXTRA_PROVIDER_NAME = "com.example.password_manager.EXTRA_PROVIDER_NAME";
    public static final String EXTRA_PROVIDER = "com.example.password_manager.EXTRA_PROVIDER";
    ...
    private void save_data() {
        ...
        String HASH = md5(sha);//hashing to md5
        ...
        intent.putExtra("name", providerNameString);
